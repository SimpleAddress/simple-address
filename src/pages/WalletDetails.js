...
const AccountDetails = ({ linkDate, numCOnnectedAccounts, ethEarned }) => {
    return (
        <Card chakraProps={{ flexGrow: '1', my: 8}}>
    ...
    return (
      ...
      >
          <Flex p={6} flexDirection='row' alignItems='center'>
            <Flex height='100vh' width={['100%', '100%', '100%', '48%']} flexDirection='column' alignItems='center' flex='1'>
                <AddressDisplay title='Address #1' subtitle='0x' subtitleClickable={false} onClick={() => {}} buttonTitle='Settings' />
            ...
            <Flex height='100vh' width={['100%', '100%', '100%', '48%']} flexDirection='column' alignItems='center' justifyContent={'flex-start'} flexGrow='1' flex='1'>
            <Box position='relative' top={3}>
                <UserActionMenu />
            </Box>
            
            <Card  width='60%' chakraProps={{ position: 'relative', top: window.innerHeight / 2.5 }}>
            <Flex
              flexDirection={"row"}
            ...
            >
              <Box>
                ...
                <Button variant="solid" color={theme.colors.primary} bgColor={theme.colors.black}>Detach address</Button>
              </Box>
