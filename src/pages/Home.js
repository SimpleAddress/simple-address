...
function Home() {
    return (
      ...
      overflowY={['scroll', 'scroll', 'hidden', 'hidden']}>
          <Flex p={10} gap={20} style={{height: '100%'}} flexDirection='column'>
        <Flex gap={10} flexDirection='row' alignItems='center'>
          ...
          <Flex flex='1.5' flexGrow={'1'}  px={5} gap={3} flexDirection={['column', 'column', 'column', 'row']} alignItems='center' justifyContent='space-around'>
              <Card chakraProps={{ height: '80%', flex: '2',  minHeight: 200 }}>
                    <Flex height='100%' flexDirection='row' alignItems='center' justifyContent='space-evenly'>
          ...
          <Flex flex='1' px={5} gap={3} flexDirection={['column', 'column', 'column', 'row']} alignItems='center' justifyContent='space-evenly'>
              <Card chakraProps={{height: '80%', width: '90%', p:8, display: 'flex', flexDirection: 'column', alignItems: 'center',  minHeight: 250}}>
              ...
              <Card chakraProps={{height: '80%', width: '90%', p:8, display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'center',   minHeight: 250}}>
              <Text fontSize={20} fontWeight='medium' textAlign='center'>
